...
test(function deleter(t) {
	...
	let inner = {a: 'a', b: 'b', c: 'c', func: func};
	let f1 = {foo: {bar: {baz: inner}}, top: {dog: 'sindre'}};

	t.is(f1.foo.bar.baz.c, 'c');
	m.del(f1, 'foo.bar.baz.c');
